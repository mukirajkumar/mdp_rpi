...
#             interfaces[ALG].write(alg_msg) #write into ALG
        ...
        if message[0] == 'AND': 
            ...
            interfaces[0].write(and_msg) #write into AND
...
#     ALG = 2
    ...
    android = Process(target=readMsg, args=(queue, interfaces[0])) #target = the function that u wanna run
    ...
    try:
        while True:
            ...
            # Send message
            print("Now writing message to android........")
            msg = msg_passing(msg) 
